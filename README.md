...
Este Projeto teve como intuito colocar em prática os conhecimentos adquiridos durante todo módulo de Fundamentos.
...
- [x] - 6. Obtenha ao menos 80% de cobertura de testes na função `handlerElephants`.
...
- [x] - 7. Obtenha ao menos 90% de cobertura de testes na função `handlerElephants`.
...
- [x] - 10. Implemente a função `getOldestFromFirstSpecies`.
...
- [x] - 11. Implemente a função `getEmployeesCoverage`.
...
- [x] - 12. Obtenha ao menos 85% de cobertura de testes na função `getOpeningHours`.
...
- [x] - 13. Obtenha ao menos 95% de cobertura de testes na função `getOpeningHours`.
...
- [x] - 15. Obtenha 100% de cobertura de testes na função `handlerElephants`.
...
- [x] - 16. Obtenha ao menos 100% de cobertura de testes na função `getOpeningHours`.
